            ...
            <div class="card">
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <table class="table table-striped table-bordered" data-table-type="datatable" data-table-name="VehicleManufacturerTable" data-table-content="{{ route('app.table.setting.vehicle.manufacturers') }}"  style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Logo</th>
...
<script>
    ...
    const name = "VehicleManufacturerTable";
