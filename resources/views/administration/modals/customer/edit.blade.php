            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        @else
                        <img src="{{ Storage::url($customers->avatar) }}" width="50px" alt=""  @if(\Illuminate\Support\Facades\Storage::exists($customers->avatar)) data-default-file="{{ \Illuminate\Support\Facades\Storage::url($customers->avatar) }}" @endif> <br> <br>
                        @endif
