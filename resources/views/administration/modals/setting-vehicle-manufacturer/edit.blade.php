<div class="modal-content">
    ...
    <form action="{{ route('app.form.submission.setting.vehicle.manufacture.update', $vehicleManufacturers->id) }}" class="ajax-form" method="post" enctype="multipart/form-data" >
