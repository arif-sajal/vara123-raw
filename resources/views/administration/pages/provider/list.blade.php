                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button class="btn btn-success" style="margin-top:15px" data-toggle="modal" data-target="#myModal" data-content="{{ route('app.modal.provider.add') }}">Add Provider</button>
