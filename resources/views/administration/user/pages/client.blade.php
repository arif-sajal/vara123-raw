                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        <li>
                                            <a data-action="reload" data-type="table" data-elem="ClientsTable">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body card-dashboard table-responsive">
                                    <table class="table table-striped table-bordered" data-table-type="datatable" data-table-name="ClientsTable" data-table-content="{{ route('user.table.clients') }}" style="width: 100%;">
                                        <thead>
                                        <tr>
                                            <th>Name</th>
                                            <th>Email</th>
...
@push('page.js')
    ...
    <script>
        window.datatable.ClientsTable.columns = [
        ...
        window.datatable.ClientsTable.language = {
