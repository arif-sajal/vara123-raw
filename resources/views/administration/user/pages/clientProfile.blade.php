                        ...
                        <div class="card profile-with-cover">
                            ...
                            <div class="media profil-cover-details w-100">
                                ...
                                <div class="media-body pt-3 px-2">
                                    <div class="row">
                                        <div class="col">
                                            <h3 class="card-title m-0">{{ $client->profile->full_name }}</h3>
                                            @if($client->banned)
                                                <p class="text-danger">{{ $client->ban_reason }}</p>
                                            @endif
                                        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <table class="table">
                                <tr>
                                    <td>Full Name</td>
                                    <td>{{ $client->profile->full_name }}</td>
                                </tr>
                                <tr>
                                    <td>Father Name</td>
                                    <td>{{ $client->profile->father_name ?? "N/A" }}</td>
                                </tr>
                                <tr>
                                    <td>Mother Name</td>
                                    <td>{{ $client->mother_name ?? "N/A" }}</td>
                                </tr>
                                <tr>
                                    <td>Date Of Borth</td>
                                    <td>{{ $client->profile->date_of_birth ? $client->profile->date_of_birth->format('d M, Y') :  "N/A" }}</td>
                                </tr>
                                <tr>
                                    <td>Gender</td>
                                    <td>{{ $client->profile->gender ?? "N/A" }}</td>
                                </tr>
                                <tr>
                                    <td>Marital Status</td>
                                    <td>{{ $client->profile->marital_status ?? "N/A" }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-content">
                            <table class="table">
                                ...
                                <tr>
                                    <td>Mobile</td>
                                    <td>{{ $client->profile->mobile ?? "N/A" }}</td>
                                </tr>
                                <tr>
                                    <td>Skype</td>
                                    <td>{{ $client->profile->skype ?? "N/A" }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-content">
                            <table class="table">
                                @if($client->profile->employment_id)
                                    <tr>
                                        <td>Employment ID</td>
                                        <td>{{ $client->profile->employment_id }}</td>
                                    </tr>
                                @endif
                                <tr>
                                    <td>Date Of Joining</td>
                                    <td>{{ $client->profile->date_of_joining ? $client->profile->date_of_joining->format('d M, Y') : "N/A" }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
