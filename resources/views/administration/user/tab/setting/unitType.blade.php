            ...
            <li>
                @component('compo.buttons.addSm')
                    ...
                    @slot('attributes')
                        data-toggle="modal"
                        data-target="#myModal"
                        data-content="{{ route('user.modal.setting.unit.type.add') }}"
                        data-hover="tooltip"
                        data-original-title="Add Unit Type"
                    @endslot
                    Add Unit Type
                @endcomponent
            </li>
            ...
            <div class="card">
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <table class="table table-striped table-bordered" data-table-type="datatable" data-table-name="UnitTypesTable" data-table-content="{{ route('user.table.setting.unit.type') }}"  style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Plural</th>
