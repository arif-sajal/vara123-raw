        ...
        <div class="card">
                        ...
                        <li>
                            @component('compo.buttons.addSm')
                                ...
                                @slot('attributes')
                                    data-toggle="modal"
                                    data-target="#myModal"
                                    data-content="{{ route('user.modal.setting.group.add',$for) }}"
                                    data-hover="tooltip"
            ...
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <table class="table table-striped table-bordered" data-table-type="datatable" data-table-name="GroupsTable" data-table-content="{{ route('user.table.setting.groups',$for) }}"  style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Group</th>
                                <th>Note</th>
