            ...
            <li>
                @component('compo.buttons.addSm')
                    ...
                    @slot('attributes')
                        data-toggle="modal"
                        data-target="#myModal"
                        data-content="{{ route('user.modal.setting.currency.add') }}"
                        data-hover="tooltip"
                        data-original-title="Add Currency"
                    @endslot
                    Add Currency
                @endcomponent
            </li>
            ...
            <div class="card">
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <table class="table table-striped table-bordered" data-table-type="datatable" data-table-name="CurrenciesTable" data-table-content="{{ route('user.table.setting.currencies') }}"  style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>Symbol</th>
                                    <th>Name</th>
...
<script>
    ...
    window.datatable[name].columns = [
        ...
        {name: 'name', data: 'name'},
        {name: 'code', data: 'code'},
        {name: 'name_plural', data: 'name_plural'},
        {name: 'exchange_rate', data: 'exchange_rate'},
