            ...
            <li>
                @component('compo.buttons.addSm')
                    ...
                    @slot('attributes')
                        data-toggle="modal"
                        data-target="#myModal"
                        data-content="{{ route('user.modal.setting.country.add') }}"
                        data-hover="tooltip"
                        data-original-title="Add Country"
                    @endslot
                    Add Country
                @endcomponent
            </li>
            ...
            <div class="card">
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        <table class="table table-striped table-bordered" data-table-type="datatable" data-table-name="CountriesTable" data-table-content="{{ route('user.table.setting.countries') }}"  style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>Name</th>
                                    <th>Code</th>
...
<script>
    ...
    window.datatable[name].columns = [
        {name: 'name', data: 'name'},
        {name: 'code', data: 'code'},
        {name: 'flag', data: 'flag', orderable: false},
