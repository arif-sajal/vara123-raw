    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ ucfirst($tab) }} Statuses</h4>
                        ...
                        <li>
                            @component('compo.buttons.addSm')
                                ...
                                @slot('attributes')
                                    data-toggle="modal"
                                    data-target="#myModal"
                                    data-content="{{ route('user.modal.setting.status.add',$tab) }}"
                                    data-hover="tooltip"
                                    data-original-title="Add Status"
                                @endslot
                                Add Status
                            @endcomponent
                        </li>
            ...
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <table class="table table-striped table-bordered" data-table-type="datatable" data-table-name="StatusesTable" data-table-content="{{ route('user.table.setting.statuses',$tab) }}"  style="width: 100%;">
                        <thead>
                            <tr>
                                <th>Status</th>
                                <th>State</th>
